...
{
    if (m_fZoomElapsedTime < 20.0f * DT && !m_bDead)
    {
    ...
    else if (m_fZoomElapsedTime < 20.0f * DT && m_bDead)
    {
    }
    else
    {
...
CCameraScript::CCameraScript() :CScript(0), m_fSpeed(200.f), m_fScaleSpeed(1.f), m_fZoomElapsedTime(0.0f), m_bCheckStartMousePoint(false), m_tEffectType(CAMERA_EFFECT_TYPE::NONE), m_bWind0Camera(false), m_bDead(false)
{
}
