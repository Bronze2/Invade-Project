...
CFireSkill0Script::CFireSkill0Script() :CScript((UINT)SCRIPT_TYPE::FIRESKILL0), m_bStart(false), m_bTickCheck(false)
{
}

CFireSkill0Script::~CFireSkill0Script()
{
}

void CFireSkill0Script::Update()
{
