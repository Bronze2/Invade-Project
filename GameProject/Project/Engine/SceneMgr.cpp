...
//
	...
	pNewAnimation->InsertAnimClip(STATE_JUMP, 81, 108); // 점프 후 팔벌리기 81, 125
	pNewAnimation->InsertAnimClip(STATE_ATTACK_READY, 145, 167);
	pNewAnimation->InsertAnimClip(STATE_ATTACK, 168, 175); // 활 꺼내서 쏘기 125, 175
	pNewAnimation->InsertAnimClip(STATE_DIE, 240, 269);		// 누워서 끝 240, 261
	...
	pNewAnimation->InsertAnimation(STATE_JUMP, 81, 109, false, false); // 점프 후 팔벌리기 81, 125
	pNewAnimation->InsertAnimation(STATE_ATTACK, 145, 175, false, false); // 활 꺼내서 쏘기 125, 175
