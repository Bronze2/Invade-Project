...
void CLobbyScene::Init()
{
 ...
 //-----------------------------------------------------------------------------------------------
    ...
    if (Network::GetInst()->getMainClient().isHost == false) {
        pUIButtonStart->Transform()->SetLocalPos(Vec3(res.fWidth / 2 - vUIButtonStartScale.x / 2, -res.fHeight / 2 + vUIButtonStartScale.y - 1000.f, 1.f));
    }
    else {
        pUIButtonStart->Transform()->SetLocalPos(Vec3(res.fWidth / 2 - vUIButtonStartScale.x / 2, -res.fHeight / 2 + vUIButtonStartScale.y, 1.f));
    ...
    if (Network::GetInst()->getMainClient().isHost) {
        pUIButtonReady->Transform()->SetLocalPos(Vec3(res.fWidth / 2 - vUIButtonStartScale.x / 2, -res.fHeight / 2 + vUIButtonStartScale.y - 1000.f, 1.f));
    }
    else {
        pUIButtonReady->Transform()->SetLocalPos(Vec3(res.fWidth / 2 - vUIButtonStartScale.x / 2, -res.fHeight / 2 + vUIButtonStartScale.y, 1.f));
