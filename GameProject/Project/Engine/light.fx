...
PS_OUTPUT PS_DirLight(VS_OUTPUT _In)
{
    ...
    float3 vViewNormal = g_tex_0.Sample(g_sam_0, _In.vUV).xyz;            // ����ī�޶� view ������� ���ؼ� ������ǥ�� �˾Ƴ���.
    tLightColor tCurCol = CalLight(g_int_0, vViewNormal, vViewPos);          // ���� �������� ������Ų ��ǥ ���ϱ�
    if (dot(tCurCol.vDiff, tCurCol.vDiff) != 0.f)                            // w �� ������ ���� ������ǥ z ���� ���Ѵ�.(�ùٸ��� ���ϱ� ���ؼ�)
    {
