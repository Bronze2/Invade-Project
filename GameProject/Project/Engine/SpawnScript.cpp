...
void CSpawnScript::SpawnObject_Red(int id, Vec3 Pos , MINION_ATTACK_TYPE type)
{
    ...
    case MINION_ATTACK_TYPE::MELEE:
    {
        ...
        CGameObject* pObject = SpawnObject(L"MeshData\\sword_min1.mdat",
            Pos, Vec3(1.f, 1.f, 1.f), Vec3(0.f, 70.f, 0.f), Vec3(100.f, 150.f, 100.f),
    ...
    case MINION_ATTACK_TYPE::CANON:
    {
        ...
        CGameObject* pObject = SpawnObject(L"MeshData\\Canon_min1.mdat", 
            Pos, Vec3(1.f, 1.f, 1.f), Vec3(0.f, 70.f, 0.f), Vec3(100.f, 250.f, 100.f),
...
void CSpawnScript::SpawnObject_Blue(int id, Vec3 Pos, MINION_ATTACK_TYPE type)
{
    ...
    case MINION_ATTACK_TYPE::MELEE:
    {
        ...
        CGameObject* pObject = SpawnObject(L"MeshData\\sword_min.mdat", Pos, 
            Vec3(1.f, 1.f, 1.f), Vec3(0.f, 70.f, 0.f), Vec3( 100.f, 150.f, 100.f), 
    ...
    case MINION_ATTACK_TYPE::CANON:
    {
        ...
        CGameObject* pObject = SpawnObject(L"MeshData\\Canon_min.mdat", Pos, 
            Vec3(1.f, 1.f, 1.f), Vec3(0.f, 70.f, 0.f), Vec3(100.f, 250.f, 100.f),
