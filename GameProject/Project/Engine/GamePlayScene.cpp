...
// Texture 로드
	...
	GetLayer(3)->SetName(L"Arrow");
	GetLayer(4)->SetName(L"Minion");
	GetLayer(5)->SetName(L"Tower");


	GetLayer(6)->SetName(L"Terrain");

	GetLayer(30)->SetName(L"Camera");
	...
	FindLayer(L"Monster")->AddGameObject(pObject, false);
	...
	FindLayer(L"Minion")->AddGameObject(pObject);
	...
	FindLayer(L"Tower")->AddGameObject(pObject);
...
void CGamePlayScene::Start()
{
	CScene::Start();
}

void CGamePlayScene::Update()
{
	CScene::Update();
}

void CGamePlayScene::LateUpdate()
{
	CScene::LateUpdate();
}

void CGamePlayScene::FinalUpdate()
{
	CScene::FinalUpdate();
}

CGamePlayScene::CGamePlayScene() : m_arrLayer{}
{
}
