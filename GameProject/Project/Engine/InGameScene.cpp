...
;
    ...
    pRedFirstTower->Transform()->SetLocalPos(Vec3(0.f, -20.f, 11500.f));
    ...
    pRedSecondTower->Transform()->SetLocalPos(Vec3(2500.f, -20.f, 14500.f));
    ...
    pRedNexus->Transform()->SetLocalPos(Vec3(1000.f, -20.f, 17600.f));
    ...
    for (int i = 0; i < 8; ++i) {
        ...
        case 0:
            ...
            pObstacle->Transform()->SetLocalPos(Vec3(2725, 40.f, 13400.f));      // R2기준 (125, -1100)
        ...
        case 1:
            ...
            pObstacle->Transform()->SetLocalPos(Vec3(-350.f, 40.f, 10600.f));      // R1 기준 (-300, -900)
            pObstacle->Transform()->SetLocalRot(Vec3(0.f, XMConvertToRadians(90.f), 0.f));
            pColObstacle->Collider3D()->SetCollider3DType(COLLIDER3D_TYPE::CUBE);
            pColObstacle->Transform()->SetLocalPos(pObstacle->Transform()->GetLocalPos());
        ...
        case 2:
            ...
            pObstacle = pMeshData->Instantiate();
            pColObstacle->Collider3D()->SetCollider3DType(COLLIDER3D_TYPE::CUBE);
            pObstacle->Transform()->SetLocalPos(Vec3(2500.f, 40.f, 9700.f));         // B1 기준 (500, 700)
            pObstacle->Transform()->SetLocalRot(Vec3(0.f, XMConvertToRadians(90.f), 0.f));
            pColObstacle->Transform()->SetLocalPos(pObstacle->Transform()->GetLocalPos());
            pColObstacle->Transform()->SetLocalRot(pObstacle->Transform()->GetLocalRot());
            pObstacle->Transform()->SetLocalScale(Vec3(1.f, 1.f, 1.f));
        ...
        case 3:
            ...
            pObstacle->Transform()->SetLocalPos(Vec3(-1100.f, 40.f, 6800.f));      // B2 기준 (-600, 1300)
            pObstacle->Transform()->SetLocalRot(Vec3(0.f, XMConvertToRadians(90.f), 0.f));
            pObstacle->Transform()->SetLocalScale(Vec3(1.f, 1.f, 1.f));
            pColObstacle->Transform()->SetLocalPos(pObstacle->Transform()->GetLocalPos());
            pColObstacle->Collider3D()->SetOffsetScale(Vec3(150.f, 150.f, 230.f));
        ...
        case 4:
            ...
            pObstacle = pMeshData->Instantiate();
            pColObstacle->Collider3D()->SetCollider3DType(COLLIDER3D_TYPE::CUBE);
            pObstacle->Transform()->SetLocalPos(Vec3(3000.f, 107.f, 15600.f));      // R2 기준 (525, 1100)
        ...
        case 5:
            ...
            pObstacle = pMeshData->Instantiate();
            pColObstacle->Collider3D()->SetCollider3DType(COLLIDER3D_TYPE::CUBE);
            pObstacle->Transform()->SetLocalPos(Vec3(-500.f, 107.f, 12700.f));      // R1 기준 (-500, 1200)
            pObstacle->Transform()->SetLocalRot(Vec3(-PI / 2, 0.f, 0.f));
            pObstacle->Transform()->SetLocalScale(Vec3(3.f, 2.f, 2.f));
            pColObstacle->Transform()->SetLocalPos(pObstacle->Transform()->GetLocalPos());
            pColObstacle->Collider3D()->SetOffsetScale(Vec3(520.f, 280.f, 240.f));
        ...
        case 6:
            ...
            pObstacle = pMeshData->Instantiate();
            pColObstacle->Collider3D()->SetCollider3DType(COLLIDER3D_TYPE::CUBE);
            pObstacle->Transform()->SetLocalPos(Vec3(2700.f, 107.f, 7700.f));      // B1 기준 (700, -1300)
            pObstacle->Transform()->SetLocalRot(Vec3(-PI / 2, 0.f, 0.f));
            pObstacle->Transform()->SetLocalScale(Vec3(3.f, 2.f, 2.f));
            pColObstacle->Transform()->SetLocalPos(pObstacle->Transform()->GetLocalPos());
            pColObstacle->Collider3D()->SetOffsetScale(Vec3(520.f, 280.f, 240.f));
        ...
        case 7:
            ...
            pObstacle = pMeshData->Instantiate();
            pColObstacle->Collider3D()->SetCollider3DType(COLLIDER3D_TYPE::CUBE);
            pObstacle->Transform()->SetLocalPos(Vec3(-1200.f, 107.f, 4700.f));      // B2 기준 (-675, -800)
            pObstacle->Transform()->SetLocalRot(Vec3(-PI / 2, 0.f, 0.f));
            pObstacle->Transform()->SetLocalScale(Vec3(3.f, 2.f, 2.f));
            pColObstacle->Transform()->SetLocalPos(pObstacle->Transform()->GetLocalPos());
            pColObstacle->Collider3D()->SetOffsetScale(Vec3(520.f, 280.f, 240.f));
    ...
    CCollisionMgr::GetInst()->CheckCollisionLayer(L"Arrow", L"Box");
    CCollisionMgr::GetInst()->CheckCollisionLayer(L"Arrow", L"Obstacle");
