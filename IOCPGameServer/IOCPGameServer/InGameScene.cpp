...
void CInGameScene::Init(int index)
{
	...
	pRedFirstTower->Sensor()->SetRadius(2000.f);
	...
	pRedSecondTower->Sensor()->SetRadius(2500.f);
	...
	pBlueFirstTower->Sensor()->SetRadius(2000.f);
	...
	pBlueSecondTower->Sensor()->SetRadius(2500.f);
