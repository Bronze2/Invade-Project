...
CCollider2D::CCollider2D() :CComponent(COMPONENT_TYPE::COLLIDER2D),m_vOffsetPos(Vec3(0.f,0.f,0.f)),m_vOffsetScale(Vec3(1.f,1.f,1.f)),m_iColID(g_iColID++),m_iCollisionCount(0)
{
...
m_vOffsetPos(_Other.m_vOffsetPos), m_vOffsetScale(_Other.m_vOffsetScale),m_eType(_Other.m_eType),
 m_iColID(g_iColID),m_iCollisionCount(0),m_matColWorld(_Other.m_matColWorld)
{
}
